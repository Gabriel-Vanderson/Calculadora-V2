#! /bin/bash
echo	"###########################################################################################"
echo	"############       Título: Calculadora em shell                                 ###########"
echo	"############       Autores: Gabriel Soares Vieira e Vanderson Vieira Lima       ###########"
echo	"############       Data: 07/12/2022                                             ###########"
echo	"###########################################################################################"
...
echo "A raiz quadrada de $numero1 é: $raiz" ;;
6)
# Potencia
echo "Digite o número escolhido: "
read numero1
